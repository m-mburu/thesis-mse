...
In a usual CART(Classification and Regression Trees)[@breiman1984classification], splits are chosen mainly for prediction. A regression tree searches for splits that reduce within-node outcome variation, while a classification tree searches for splits that improve class separation [@hastie2009elements].
...
report_compact_table(
  ...
  column_widths = c("1.2cm", "1.6cm", "1.8cm", "4.0cm", "2.7cm", "2.7cm"),
  font_size = 11,
  scale_down = TRUE
)
```
