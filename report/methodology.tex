...
DHS Program, 2007a}). Under-five mortality is treated as the outcome,
and the DHS household wealth index serves as the socioeconomic ranking
variable. This is appropriate for the DRC setting, where DHS-based
research has shown that poverty and education are associated with access
to health insurance
...
Congo DHS Phase V survey (\citeproc{ref-dhs_drc_2007_dataset}{The DHS
Program, 2007a}). The analysis includes children with complete
...
The DHS Program (2007a) {`{Congo Democratic Republic: Standard DHS,
...
The DHS Program (2007b) {`Wealth index construction'}. The DHS Program.
Available at:
