...
Compared with other statistical methods used in decomposition, such as
generalised linear models and tree-based models, tree-based models are
easier to interpret. The variable percentage contribution from
regression or Shap-based decomposition can show which variables
contribute more. However, it cannot show how disadvantage is organised
across residence, household wealth, occupation, maternal background, and
province. A tree is easier to discuss because it works like a flow
chart. As shown in this thesis, the tree partitions the data graphically
into high- and low-risk groups. Concentration index trees make it easier
to follow the path to these high- and low-risk groups and identify them
