...
\urlstyle{same}
\hypersetup{
  pdftitle={Decomposing health inequalities through regression trees},
...
\title{Decomposing health inequalities through regression trees}
\author{Moses Mburu}
\date{}
\begin{document}
\maketitle
...
(\citeproc{ref-wagstaff2003decomposing}{{Wagstaff, van Doorslaer and
Watanabe}, 2003}; \citeproc{ref-speybroeck2010decomposing}{Speybroeck
\emph{et al.}, 2010}; \citeproc{ref-survey2026}{Lumley, 2026}). We then
used the Rineq R package(\citeproc{ref-rineq2025}{Devleesschauwer
\emph{et al.}, 2025}) for decomposition. The second indirect method is
the SHAP-based decomposition described in
...
package with the ranger package as backend, and the fitted predictions
are then decomposed into SHAP contributions at the determinant level
before applying the concentration-index decomposition
...
package (\citeproc{ref-rpart2026}{Therneau and Atkinson, 2026}) with a
custom concentration-index splitting method. The comparison used the
same outcome, socioeconomic ranking variable, and analysis weights as
the main concentration-index tree. Node impurity was also defined using
the absolute concentration index. The main difference was in the
tree-growing tools. In the main implementation, we used custom and
Partykit controls (\citeproc{ref-hothorn2015partykit}{Hothorn and
Zeileis, 2015}). A split was accepted only if it satisfied the
concentration-index tree controls: minimum parent-node size, minimum
child-node size, minimum child-node proportion, maximum depth, minimum
absolute gain, and minimum relative gain (introduced for this thesis).
...
From the indirect decomposition, contribution output gives the largest
CI regression contribution to mother's education, followed by father's
occupation in agriculture, mother's occupation in agriculture, household
wealth, residence, and skilled birth attendance
(Table~\ref{tbl-results-method-comparison}). In the predictive-forest
SHAP decomposition, the contributions were less concentrated in one or
two variables. Residence and household wealth each contributed about
12\% under CI, CIg and CIc, followed by mother's occupation, father's
occupation, mother's education and skilled birth attendance. The fitted
...
\midrule
Mother's education & 33.080 & -8.251 & -24.861 & 11.110 & 11.110 & 11.110 & 12.684\\
Father's occupation: Agriculture & 25.627 & -5.712 & -17.210 & 4.619 & 4.619 & 4.619 & 5.060\\
Mother's occupation: Agriculture & 16.763 & -4.134 & -12.456 & 3.474 & 3.474 & 3.474 & 3.262\\
Household wealth & 13.079 & -2.524 & -7.605 & 11.531 & 11.531 & 11.531 & 6.980\\
Type of residence & 12.529 & -3.408 & -10.269 & 21.630 & 21.630 & 21.630 & 21.038\\
\addlinespace
Skilled birth attendance & 11.259 & -2.869 & -8.644 & 10.058 & 10.058 & 10.058 & 7.107\\
Region: Equateur & 5.396 & -0.306 & -0.922 & 3.165 & 3.165 & 3.165 & 4.165\\
Father's occupation: Household, unskilled, not working & -4.835 & 0.274 & 0.827 & -0.430 & -0.430 & -0.430 & -0.343\\
Region: Kinshasa & -4.621 & 0.186 & 0.560 & 1.246 & 1.246 & 1.246 & 2.054\\
Region: Sud-Kivu & -2.878 & 0.061 & 0.184 & -0.688 & -0.688 & -0.688 & -0.434\\
\addlinespace
Region: Kasai Oriental & -2.505 & 0.147 & 0.444 & 0.106 & 0.106 & 0.106 & 0.096\\
Father's education & -2.097 & 0.250 & 0.752 & 3.043 & 3.043 & 3.043 & 3.500\\
Region: Maniema & 1.542 & -0.024 & -0.072 & 3.124 & 3.124 & 3.124 & 4.218\\
Region: Orientale & -1.412 & 0.072 & 0.217 & 0.283 & 0.283 & 0.283 & 0.107\\
Region: Bas-Congo & -0.973 & 0.017 & 0.052 & 0.048 & 0.048 & 0.048 & 0.474\\
\addlinespace
Mother's occupation: Household, unskilled, not working & 0.860 & -0.088 & -0.265 & 0.094 & 0.094 & 0.094 & -0.068\\
Birth order and interval: 5+ short interval & -0.757 & 0.034 & 0.103 & 1.214 & 1.214 & 1.214 & 4.518\\
Region: Kasai Occidental & 0.703 & -0.033 & -0.099 & 0.007 & 0.007 & 0.007 & 0.102\\
Birth order and interval: 5+ long interval & -0.627 & 0.073 & 0.219 & -0.333 & -0.333 & -0.333 & -0.040\\
Sex of the child & -0.599 & 0.130 & 0.393 & 0.068 & 0.068 & 0.068 & -0.005\\
\addlinespace
Region: Katanga & -0.425 & 0.019 & 0.058 & -0.155 & -0.155 & -0.155 & -2.068\\
Mother's age at birth & 0.375 & -0.071 & -0.215 & 0.505 & 0.505 & 0.505 & 0.613\\
Region: Nord-Kivu & 0.299 & -0.005 & -0.015 & 0.619 & 0.619 & 0.619 & 0.429\\
Birth order and interval: 2-4 long interval & 0.222 & -0.033 & -0.100 & 0.409 & 0.409 & 0.409 & 0.106\\
Birth order and interval: 2-4 short interval & -0.005 & 0.000 & 0.001 & 0.458 & 0.458 & 0.458 & 0.231\\
\bottomrule
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{MSE_Thesis_Decomposition_of_CI_Trees_MM_files/figure-pdf/fig-results-surrogate-tree-1.pdf}
...
\pandocbounded{\includegraphics[keepaspectratio]{MSE_Thesis_Decomposition_of_CI_Trees_MM_files/figure-pdf/fig-appendix-simulation-positive-control-cic-1.pdf}}
