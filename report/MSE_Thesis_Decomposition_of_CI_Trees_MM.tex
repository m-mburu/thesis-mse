...
\subsubsection{Split behaviour under alternative concentration-based
...
(\citeproc{ref-erreygers2017socioeconomic}{Erreygers and Kessels,
2017}). The \(L\) results should therefore be read as a sensitivity
analysis using the available DHS wealth score, not as a direct
welfare-level decomposition.
...
rank-dependent trees. Another direction is to study the hyperparameters
more systematically. Controls such as minimum node size, minimum
child-node proportion, maximum depth, minimum gain, and minimum relative
gain can alter the final tree structure, depending on the study's
purpose. Future work could therefore examine how these controls affect
validation gain, terminal-node size, and the stability of the subgroups
found by the model.
