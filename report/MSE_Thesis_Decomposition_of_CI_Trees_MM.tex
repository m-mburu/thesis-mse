...
decompose cleanly across population groups, and this may also help
explain why \(L\) validated better as a tree impurity criterion in this
application: children inherit their socioeconomic level within each
subgroup, rather than being re-weighted only by a new within-node rank.
However, the DHS wealth index is an asset-based score
(\citeproc{ref-dhsprogram_wealth_index_construction}{The DHS Program,
