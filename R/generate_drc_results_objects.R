params <-
list(analysis_rows = 1L, tuning_folds = 10L, undersample = 0.4)
...
tree_grid <- ci_tree_control_grid(
    minsplit = c(500L,750L, 1000L, 2000L),
    minbucket = c(100L),
    minprob = 0.01,
    maxdepth = 10L,
    min_gain = 0.0001,
    min_relative_gain = c(0.05, 0.1, 0.20, 0.30)
)
